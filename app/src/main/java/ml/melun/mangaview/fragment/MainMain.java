...
import ml.melun.mangaview.adapter.MainNovelAdapter;
...
import static ml.melun.mangaview.mangaview.MTitle.*;
...
public class MainMain extends Fragment {
    ...
    MainNovelAdapter mainNovelAdapter;
    Fragment fragment;
    boolean wait = false;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                } else if (tab.getPosition() == NOVEL_TAB) {
                    mainRecycler.setAdapter(mainNovelAdapter);
                    p.setBaseMode(base_novel);
                }
            }
